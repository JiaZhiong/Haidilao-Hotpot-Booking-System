...
@JsonPropertyOrder(value = {"seatId", "menu", "room", "bookedDateTime", "dueDateTime", "paid"}, alphabetic = true)
@JsonIgnoreProperties({"bookedDateTimeStr", "dueDateTimeStr", "menuPkg", "roomNumber"})
